...
llama_context_params llama_context_default_params() {
    llama_context_params result = {
        ...
        /*.yarn_orig_ctx               =*/ 0,
        /*.defrag_thold                =*/ -1.0f,
        /*.n_predict_tokens            =*/ 16,    // ULTRA AGGRESSIVE MTP: predict 16 tokens for maximum speedup
        /*.mtp_accept_rate             =*/ 0.3f,  // ULTRA AGGRESSIVE: lowest threshold for maximum acceptance
        /*.cb_eval                     =*/ nullptr,
